...
<footer id="footer">
          ...
          <div class="col-lg-3 col-md-6 footer-links">
              ...
              <ul>
                  <li>
                      ...
                      <a href="/tentang-website">Info Aplikasi & Developer</a>
                  </li>
              </ul>
          </div>
    ...
    <div class="container">
      <div class="copyright">
        Desa Cikarag Kabupaten Garut &copy;Copyright <strong><span>2026</span></strong>. || Developed By : <a href="https://bsi.ac.id/">Mahasiswa Bina Sarana Informatika PSDKU Tasikmalaya</a>
      </div>
    </div>
    <script>
        console.log(
        `Website Desa Cikarag
        Developed by:
        - Abdul Jabar
        - Yoga
        - Ihsan Qolbu`
