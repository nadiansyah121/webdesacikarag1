...
<div class="top-notification">
    <div class="container">
        <marquee behavior="scroll" direction="left" scrollamount="5">
            ...
            |
            Klik untuk lihat:
            <a href="/pengumuman/{{ $announcement->slug }}" style="color:yellow;">
                Baca Selengkapnya
            </a>
        </marquee>
    </div>
            ...
            <ul>
                ...
                <li>
                    <a href="/login" class="nav-link scrollto">Masuk</a>
                                    ...
                                    {{-- @if($announcement)
                    <li class="position-relative" style="margin-right:20px;">
                        <a href="/pengumuman/{{ $announcement->slug }}"
                        onclick="localStorage.setItem('announcement_read', '1')">
