...
Route::get('/admin/chat-history', function () {
...
Route::get(
    '/admin/chat-history',
    [ChatbotController::class, 'history']
)->name('chat-history.index');

Route::delete(
    '/admin/chat-history/clear',
    [ChatbotController::class, 'clear']
)->name('chat-history.clear');

Route::delete('/admin/chat-history/{id}', function ($id) {
...
Route::resource(
    'chatbot-knowledge',
    ChatbotKnowledgeController::class
);


// tentang aplikasi buat kenang-kenangan
Route::get('/tentang-website', function () {
    return view('tentang-website.index');
});
